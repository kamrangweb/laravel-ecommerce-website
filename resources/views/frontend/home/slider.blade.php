...
<section class="hero-area">
    <div class="hero-image">
        @if(!empty($banner->resim))
            <img src="{{ asset($banner->resim) }}" alt="Hero Background">
        @else
        ...
        <div class="container">
            <div class="hero-content text-center">
                <h1 class="display-4 fw-bold mb-4">{{ $banner->baslik ?? 'Welcome to Our Store' }}</h1>
                <p class="lead mb-5">{{ $banner->alt_baslik ?? 'Discover amazing products at unbeatable prices' }}</p>
                <div class="hero-btn">
                    @if(!empty($banner->url))
